...
if(isset($_POST['upid'])){  
$add =  $p->updateRegistro($_POST,'pagina_cursos','id',1);   
$add2 =  $p->addImages($_FILES,'banners', $sessao);  
}  

if(isset($_SESSION['radmin'])){  
$pd =  $p->getRegistro('pagina_cursos','id',1);
} 
...
<div class=" form">
<form action="?nossoscursos_edit" method="POST" id="commentForm" class="cmxform form-horizontal tasi-form" novalidate="novalidate"  enctype="multipart/form-data">
...
<a href="?nossoscursos_edit&banner_del=<?=$va['bannerId']?>" onClick="return confirm('Deseja apagar?')"> 
...
<a href="#" class="btn btn-danger fileupload-exists" data-dismiss="fileupload2"><i class="fa fa-trash"></i> Remover</a>
	...
	<div class="form-group ">
		...
		<div class="col-lg-10">
			<textarea type="text" required="" minlength="2" name="titulo" id="titulo"   class="form-control "><?=$pd['titulo']?></textarea>
		</div>
	</div>

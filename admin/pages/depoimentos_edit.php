...
if(isset($_POST['upid'])){ 
$add =  $p->updateRegistro($_POST,'depoimentos','depoimentoId',$_POST['upid']);   
}  

if(isset($_GET['pid'])){  
$pd =  $p->getRegistro('depoimentos','depoimentoId',$_GET['pid']);
} 
...
<div class=" form">
<form action="?depoimentos_edit&pid=<?=$_GET['pid']?>" method="POST" id="commentForm" class="cmxform form-horizontal tasi-form"   enctype="multipart/form-data">
<input type="hidden" value="<?=$pd['depoimentoId']?>" name="upid">
...
<div class="col-lg-10">
<textarea name="depoimento"  class="form-control "><?=$pd['depoimento']?></textarea>
</div>
</div>

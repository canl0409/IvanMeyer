...
if(isset($_GET['dpid'])){
$p->del('categorias','categoriaId',$_GET['dpid']);
                  ...
                  <div class="panel-body">
                        ...
                        <div class="adv-table">
                            <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                                ...
                                <tbody>
                                <?php $q = $p->lista('categorias'); foreach ($q as $r) {
                                    
                                ?>
                                <tr class="gradeX">
                                    <td> <img style="width:40px;" src="../assets/imgs/<?=$r['imagem']?>" /> </td>
                                    <td><?=$r['nome']?></td>

                                    <td class="center hidden-phone"> 
                                    <a href="?categorias_edit&pid=<?=$r['categoriaId']?>" >
                                    <button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button>
                                    </a>
                                    <a href="?categorias_listar&dpid=<?=$r['categoriaId']?>" onClick="return confirm('Deseja apagar?')"> 

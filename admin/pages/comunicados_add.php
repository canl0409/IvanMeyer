...
<option class="corretoras todasco  form-control" selected value="todas">Todas</option>
<?php 
$g = $p->lista('corretoras'); 
$i = 0;
foreach ($g as $rg) { $y = $i++;   ?>
<option class="corretoras corr   form-control"  value="<?=$rg['corretoraId']?>" id="<?=$rg['corretoraId']?>"> <?=$rg['nome']?> </option>
<?php } ?>
</select>
</div>

...
$add =  $p->updateRegistroImg($_POST,$_FILES,'categorias','categoriaId',$_POST['upid'],'imagem','../assets/imgs/');  
}  

 

if(isset($_GET['pid'])){  
$pd =  $p->getRegistro('categorias','categoriaId',$_GET['pid']);
} 
...
<div class=" form">
<form action="?categorias_edit&pid=<?=$_GET['pid']?>" method="POST" id="commentForm" class="cmxform form-horizontal tasi-form"    enctype="multipart/form-data">
...
<?php  if($pd['imagem']){ ?>
<img src="../assets/imgs/<?=$pd['imagem']?>" alt="" style="max-width: 200px; max-height: 150px; line-height: 20px;">
<?php }else{  ?>

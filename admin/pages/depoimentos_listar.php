...
if(isset($_GET['dpid'])){
$p->del('depoimentos','depoimentoId',$_GET['dpid']);
...
<td> <?php  if($r['status'] == 0){ $st = 'Reprovado'; $cla='label-danger';}else{$st = 'Aprovado'; $cla='label-success';} ?>
<span class="badge <?=$cla?> label-mini"><?=$st?></span>
</td>

  
<td> 
<a href="?depoimentos_edit&pid=<?=$r['depoimentoId']?>" >
<button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button>
</a>

<a href="?depoimentos_listar&dpid=<?=$r['depoimentoId']?>" onClick="return confirm('Deseja apagar?')"> 

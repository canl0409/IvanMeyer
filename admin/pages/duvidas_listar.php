...
if(isset($_GET['dpid'])){
$p->del('duvidas','duvidaId',$_GET['dpid']);
...
<td> 
<a href="?duvidas_edit&pid=<?=$r['duvidaId']?>" >
<button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button>
</a>

<a href="?duvidas_listar&dpid=<?=$r['duvidaId']?>" onClick="return confirm('Deseja apagar?')"> 

   <?php 
    ...
    if(isset($_POST['titulo'])){  
     $add =  $p->addRegistro($_POST,'opinioes');
    } ?>
...
<div class=" form">
<form action="?opinioes_add" method="POST" id="commentForm" class="cmxform form-horizontal tasi-form"    enctype="multipart/form-data">



<div class="form-group ">
<label class="control-label col-lg-2" for="titulo">Nome </label>
<div class="col-lg-10">
...
<div class="col-lg-10">
<textarea name="opiniao"  class="form-control "></textarea>
</div>
</div>
...
<div class="col-lg-10">
<input type="number" required="" min="1" max="5" name="nota" id="nota" class="form-control ">
</div>
</div>

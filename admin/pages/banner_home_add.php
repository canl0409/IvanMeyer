    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <div class=" form">
                    <form action="?banners_listar" method="POST" id="commentForm" class="cmxform form-horizontal tasi-form" novalidate="novalidate" enctype="multipart/form-data">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-lg-10">
                                <select name="sessao" id="" class="form-control ">
                                    ...
                                    foreach ($cps as $cp) {
                                    ?>
                                        <option value="plano<?= $cp['categoriaId'] ?>"><?= $cp['nome'] ?> (plano<?= $cp['categoriaId'] ?>)</option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>

...
$flowConfig->setBankTxnPendingUrl($url_base);
...
$presentation->setLogoImage($url_base."/assets/imgs/logo_site.png")
//	A label that overrides the business name in the PayPal account on the PayPal pages.
    ->setBrandName("Terra da Música")
//  Locale of pages displayed by PayPal payment experience.
    ->setLocaleCode("BR")
// A label to use as hypertext for the return to merchant link.
    ->setReturnUrlLabel("Voltar")
...
$webProfile->setName("Terra da Música - " . uniqid())
...
try {
    ...
    echo "ERRO ao criar WebProfile.<br/>";
    echo "Recarregue a página e tente novamente.<br/>";
    echo "Caso o erro persista, entre em contato com o administrador do site.<br/>";
    //print_r($request);
    //print_r($ex);
    exit(1);
}
// NOTE: PLEASE DO NOT USE RESULTPRINTER CLASS IN YOUR ORIGINAL CODE. FOR SAMPLE ONLY
//echo "Created Web Profile - Web Profile ID: ".$createProfileResponse->getId();
$webProfileId = $createProfileResponse->getId();
// print_r($request);
// print_r($createProfileResponse);

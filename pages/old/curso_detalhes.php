<?php $inst = $gm->getRegistro('instrutores', 'instrutorId', $cs['instrutorId']);
$cat = $gm->getRegistro('categorias', 'categoriaId', $cs['categoria_principal'] ? $cs['categoria_principal'] : $cs['categoriaId']);
$opinions = $gm->lista('opinioes', " where cursoId = '" . $cs['cursoId'] . "' and status = '1' ");
...
<?php if ($cs['banner'] != '') { ?>
    <section class="home-section curso-section home-parallax home-fade bg-dark-30" id="home" data-background="<?= u ?>assets/imgs/cursos/<?= $cs['banner'] ?>">
    <?php } else { ?>
        <section class="home-section curso-section home-parallax home-fade bg-dark-30" id="home" data-background="<?= u ?>assets/imgs/banner.png">
        <?php } ?>
                    ...
                    <div class="row curso-box">
                        <div class="col-sm-8 col-md-9">
                            ...
                            <div class="course-meta">
                                <div class="course-author" itemscope="" itemtype="http://schema.org/Person"><img alt="" src="<?= u ?>assets/imgs/team/<?= $inst['foto'] ?>" class="avatar avatar-40 photo" width="40" height="40">
                                ...
                                <div class="course-categories">
                                    ...
                                    <div class="value"><span class="cat-links"><a href="#" rel="tag"><?= money($cs['valor']) ?></a></span>
                                    </div>
                                </div>
                            ...
                            <?php if ($cs['video']) { ?>
                                <div class="cvideo">
                                    <iframe id="iframeVideoHome" src="<?= str_replace('vimeo.com/', 'player.vimeo.com/video/', $cs['video']) ?>" width="100%" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                                </div>
                                <?php } else {

                                if ($cs['imagem'] == '') { ?>
                                    <div class="image-course" style="background-image: url('<?= u ?>assets/imgs/image.png')"></div>
                                <?php } else { ?>
                                    <div class="image-course" style="background-image: url('<?= u ?>assets/imgs/cursos/<?= $cs['imagem'] ?>')"></div>
                                <?php } ?>
                            ...
                            <div role="tabpanel" class="mt-30 mb-30" id="tabscurso">
                                <ul class="nav nav-tabs font-alt" role="tablist">
                                    <li class="active"><a href="#descricao" data-toggle="tab"><span class="fas fa-bookmark"></span>Descrição</a></li>
                                    <li><a href="#estrutura" id="tabstruture" data-toggle="tab"><span class="fab fa-codepen"></span> Conteúdo</a></li>
                                ...
                                <div class="tab-content">
                                                ...
                                                <div class="detalhes-curso">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><i class="fas fa-stopwatch"></i>
                                                            <div>Duração</div>
                                                            <span><?= $cs['duracao'] ?> horas</span>
                                                        </li>
                                                        <li><i class="fas fa-certificate"></i>
                                                            <div>Certificado</div>
                                                            <span><?= $cs['certificado'] ?></span>
                                                        </li>
                                    ...
                                    <div class="tab-pane" id="estrutura">
                                        ...
                                        ?>
                                            <h2 class="modulotitle" rel="<?= $mod['moduloId'] ?>"><span class="glyphicon glyphicon-plus btModuloPlus"></span> <?= $mod['nome'] ?>
                                            </h2>
                                            <ul class="section-content mod-content mod-<?= $mod['moduloId'] ?>">
                                                ...
                                                foreach ($aulas as $au) {
                                                    $aut = $aut + 1;
                                                ?>
                                                    <li class="course-lesson course-item free-item preview-item " rel="<?= $au['aulaId'] ?>" data-course="<?= ln($cs['titulo']) ?>">
                                                        <div class="meta-left">
                                                            <span class="course-format-icon"><i class="fas <?= tipoMidia($au['video'], $au['texto'], $au['audio'], 1) ?>"></i>
                                                            </span>
                                                            <div class="index">
                                                                <span class="label" style="width:40px;"><?= tipoMidia($au['video'], $au['texto'], $au['audio']) ?></span><?= $aut ?>
                                                            </div>
                                                        </div>
                                                        <a style="display: inline" class="lesson-title course-item-title button-load-item" href="javascript:void(0)"><?= $au['titulo'] ?></a>
                                                        <div class="course-item-meta">

                                                            <?php if ($au['free'] == 1) { ?>
                                                                <a id="free" title="Previews" class="  lesson-preview button-load-item tag-free" href="javascript:void(0)">Free </a>
                                                            <?php } ?>


                                                            <a title="Previews" rel="au-<?= $au['aulaId'] ?>" class="indviewed <?php if ($gm->viwedAula($au['aulaId'])) {
                                                                                                                                    echo "aviwed";
                                                                                                                                } ?> lesson-preview button-load-item" href="javascript:void(0)"> <i class="fas fa-check-circle" aria-hidden="true"></i>
                                                            </a>


                                                            <span class="lp-icon item-status"></span></div>
                                                        <div class="meta only-desktop"><?= $au['duracao'] ?> minutos</div>
                                                    </li>
                                                <?php } ?>
                                            </ul>
                                        <?php } ?>
                                        ...
                                        <ul class="section-content" style="display: block;">
                                            ...
                                            ?>
                                                <li class="course-lesson course-item free-item preview-item " rel="<?= $au['aulaId'] ?>" data-course="<?= ln($cs['titulo']) ?>">
                                                    ...
                                                    <a class="lesson-title course-item-title button-load-item" href="javascript:void(0)"><?= $au['titulo'] ?></a>
                                                    <div class="course-item-meta">
                                                        <?php if ($au['free'] == 1) { ?>
                                                            <a title="Previews" class=" tag-free lesson-preview button-load-item" href="javascript:void(0)">Free </a>
                                                        <?php } ?>


                                                        <a title="Previews" rel="au-<?= $au['aulaId'] ?>" class="indviewed <?php if ($gm->viwedAula($au['aulaId'])) {
                                                                                                                                echo "aviwed";
                                                                                                                            } ?> lesson-preview button-load-item" href="javascript:void(0)">
                                        ...
                                        <div class="thim-about-author">
                                            <div class="author-wrapper">
                                                <div class="author-avatar">
                                                    <img alt="Admin bar avatar" src="<?= u ?>assets/imgs/team/<?= $inst->foto ?>" class="avatar avatar-110 photo" width="110" height="110">
                                                </div>
                                    ...
                                    <div class="tab-pane content-review" id="opinioes">
                                        ...
                                        <ul class="course-reviews-list">
                                            <?php foreach ($opinions as $opn) { ?>
                                                <li>
                                                    <div class="review-container" itemprop="itemReviewed" itemscope="" itemtype="http://schema.org/Review">
                                                        <div class="review-author">
                                                            <img alt="avatar" src="<?= u ?>assets/imgs/avatar.png" class="avatar avatar-70 photo" width="70" height="70">
                                                        </div>
                                                        <div class="review-text">
                                                            <h4 class="author-name" itemprop="author">
                                                                <?php
                                                                if ($opn['alunoId']) {
                                                                    $aluno = $gm->getRegistro('alunos', 'alunoId', $opn['alunoId']);
                                                            ...
                                                            <div class="review-star starrr" rel="<?= $opn['nota'] ?>"></div>
                                        ...
                                        <?php if (isset($_SESSION['aluno'])) { ?>
                                            ...
                                            <form action="" class="form-control" style="height: auto;" id="opiniao">
                                                ...
                                                <div class="form-group">
                                                    <textarea style="max-height: 150px;" class="form-control" rows="7" id="message" name="opiniao" placeholder="Sua avaliação*" required="required" data-validation-required-message="Informe Sua mensagem"></textarea>
                                                    <p class="help-block text-danger"></p>
                                                </div>

                                                <div class="form-group">
                                                    <input type="submit" class="form-control btn " value="Enviar" style="color:#fff">
                                                </div>
                            ...
                            <ul class="section-content">
                                ...
                                foreach ($modulos as $mod) { ?>
                                    ...
                                    ?>
                                        ...
                                        <li class="course-lesson course-item  free-item preview-item viewable  mod-content mod-<?= $mod['moduloId'] ?>" data-type="lp_lesson" id="au<?= $au['aulaId'] ?>" rel="<?= $au['aulaId'] ?>">
                                            ...
                                            <a class="lesson-title course-item-title button-load-item" href="javascript:void(0)"><?= $au['titulo'] ?>
                                ...
                                ?>
                                    ...
                                    <li class="course-lesson course-item  free-item preview-item viewable" data-type="lp_lesson" id="au<?= $au['aulaId'] ?>" rel="<?= $au['aulaId'] ?>">
                                        <div class="meta-left"> <span class="course-format-icon">
                                                <i class="fas <?= tipoMidia($au['video'], $au['texto'], $au['audio'], 1) ?>"></i>
                                            </span>
                                            <div class="index">
